...
public class VideoEncodeBolt implements IRichBolt{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2195720016261957222L;
	...
	public VideoEncodeBolt(String outputDir, String hdfsServer) {
		super();
		this.m_outputDir = outputDir;
		this.m_hdfsServer = hdfsServer;
	}
	...
	public void prepare(Map stormConf, TopologyContext context,
		...
		log.info("try to connect HDFS:"+m_hdfsServer);
...
//				outputFile);
		List<String> command = RunCommand.ffmpegCommandBuilder(
				inputVideo.getCodingSpeed(),inputVideo.getInputFileName(), outputFile, inputVideo.getMaxThread());
